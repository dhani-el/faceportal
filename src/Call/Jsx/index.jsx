...
export default function Call(){
   ...
   const animation2 = {
    ...
    return <motion.div className="w-screen h-screen block  overflow-hidden relative justify-between "  ref={mainRef} variants={animation1} initial = {"initial"} animate = {openChatControls} >
